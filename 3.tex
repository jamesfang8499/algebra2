...
\[1, \frac 18, \frac {1}{27}, \ldots, \frac {1}{n^{3}}\]
...
\end{enumerate}    
\end{multicols}
\item 数列$\{a_n\}$中，已知$a_1=2$，且$a_{n+1}=a_n+\frac{4}{a_n},\quad (n\in\N)$.
...
\item 设$a_n=\frac{1}{3}\x2^n=256$，则$n=8+\log_2 3$不是整数，所以256不是数列中的项。
