...
\begin{minipage}{.5\textwidth}
    \[\begin{split}
\frac{z_1}{z_2}=\frac{1+2\sqrt{3}i}{7+\sqrt{3}i}&=\frac{\left(1+2\sqrt{3}i\right)\left(7-\sqrt{3}i\right)}{\left(7+\sqrt{3}i\right)\left(7-\sqrt{3}i\right)}\\
...
\[\begin{split}
    ...
    &\quad=\sqrt[8]{2}\left(\pc{\frac{7\pi}{16}}\right)\cdot \left(\pc{\frac{\pi}{2}}\right)\\
    &\sqrt[8]{2}\left[\pcx{\frac{7\pi}{16}+\frac{\pi}{2}\x 2}\right]\\
    &\quad=\sqrt[8]{2}\left(\pc{\frac{7\pi}{16}}\right)\cdot \left(\pc{\frac{\pi}{2}}\right)^2\\
    &\sqrt[8]{2}\left[\pcx{\frac{7\pi}{16}+\frac{\pi}{2}\x 3}\right]\\
    &\quad=\sqrt[8]{2}\left(\pc{\frac{7\pi}{16}}\right)\cdot \left(\pc{\frac{\pi}{2}}\right)^3\\
\end{split}\]
\end{enumerate}
\end{note}
...
\begin{analyze}
    三次方程解起来比较困难，但考虑到$|\bar z|=z$，可利用复数相等则模一定相等的道理，以达到降次的目的.
\end{analyze}

\begin{solution}
在方程两边取模，得
\[|\bar z^3|=|z|\Longleftrightarrow |\bar z|^3=|z|\Longleftrightarrow |z|^3-|z|=0\]
...
\end{minipage}
\begin{minipage}{.4\textwidth}
\centering\begin{tikzpicture}[>=stealth, scale=1.5]
...
\textbf{解1：}设$\frac{z}{z-1}=bi\; (b\in\R,\; b\ne 0)$，则$(1-bi)z=-bi$. 由于$1-bi\ne 0$，
...
\end{cases}&\Rightarrow |z_3|^2 =z_1\bar z_1+z_2\bar z_2+z_1 z_2+z_2\overline{\overline{z_1}}\\
&\Rightarrow |z_3|^2 =|z_1|^2+|z_2|^2+z_1 \bar z_2+\bar z_1 z_2\\
&\Rightarrow z_1 \bar z_2+\bar z_1 z_2=|z_3|^2-|z_1|^2-|z_2|^2=-|z_3|^2=-r^2
\end{split}\]
